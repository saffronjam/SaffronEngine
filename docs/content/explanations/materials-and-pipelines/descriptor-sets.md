...
| 1 | Frame lighting | `0` globals; `1` punctual lights; `2` cluster lists; `3` cluster params; `4-7` shadow maps; `8-10` SDF/GDF data; `11` froxel integration; `12` cloud shadows |
